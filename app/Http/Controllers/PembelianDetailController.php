...
class PembelianDetailController extends Controller
{
    public function index()
    {
        ...
        return view('pembelian_detail.index', compact('id_pembelian', 'produk', 'supplier', 'diskon', 'invoice'));
    }
    ...
    {
        $jumlah = empty($request->jumlah) || $request->jumlah == 'NaN' ? 1 : $request->jumlah;
        $detail = PembelianDetail::find($id);
        $detail->jumlah = $jumlah;
        $detail->subtotal = $detail->harga_beli * $jumlah;
        $detail->update();
    }
