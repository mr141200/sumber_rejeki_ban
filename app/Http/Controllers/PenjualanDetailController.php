...
class PenjualanDetailController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['harga_jual']  = '<input type="number" class="form-control input-sm harga-jual" data-id="'. $item->id_penjualan_detail .'" value="'. $item->harga_jual.'">';
    ...
    public function update(Request $request, $id)
    {
        ...
        $detail->subtotal = $request->harga_jual * $request->jumlah;
