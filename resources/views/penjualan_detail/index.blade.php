            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="tampil-terbilang" style="text-align:center;"></div>
                    </div>
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="diterima" class="form-control" name="diterima" value="{{ $penjualan->diterima ?? 0 }}" readonly>
                                </div>
                            </div>
                            <!-- <div class="form-group row">
...
<script>
    ...
    $(function () {
        ...
        // $(document).on('mouseout', '.quantity', function () {
        //     reloadProduct();
        // });
        // $(document).on('mouseout', '.harga-jual', function () {
        //     reloadProduct();
        // });
        $(document).on('change', '.quantity', function () {
            let id = $(this).data('id');
            let jumlah = parseInt($(this).val());
            let hargaJualInput = $(this).closest('td').prev().children();
            let hargaJual = hargaJualInput.val();
            if (jumlah < 1 ) {
                $(this).val(1);
            ...
            if (hargaJual < 1000 ) {
                hargaJualInput.val(1000);
                alert('Harga tidak boleh lebih dari 10000');
                return;
            }
            if(!(isNaN(jumlah) || isNaN(hargaJual))){
                console.log('tes');
        ...
        $(document).on('change', '.harga-jual', function () {
            let id = $(this).data('id');
            let hargaJual = parseInt($(this).val());
            let jumlahInput = $(this).closest('td').next().children();
            ...
            if(!(isNaN(jumlah) || isNaN(hargaJual))){
                $.post(`{{ url('/transaksi') }}/${id}`, {
                    ...
                    .fail(response => {
                        alert('Periksa kembali detail barang');
                    });
